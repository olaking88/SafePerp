 ...
 * IDL can be found at `target/idl/arcium_perp.json`.
 */
export type ArciumPerp = {
  "address": "76C52sp1b4MbXW6H64H3zDXqaHbGqfT915NVcUm6oZXn",
  "metadata": {
    "name": "arciumPerp",
    "version": "0.1.0",
    "spec": "0.1.0",
    "description": "Arcium private perp trading program"
  },
  "instructions": [
    {
      "name": "arciumComputeLiquidation",
      "discriminator": [
        41,
        188,
        117,
    ...
    {
      "name": "computeLiquidationCallback",
      "discriminator": [
        161,
        176,
        158,
    ...
    {
      "name": "initComputeLiquidationCompDef",
      "discriminator": [
        7,
        126,
        15,
    ...
    {
      "name": "initEncryptPositionCompDef",
      "discriminator": [
        47,
        118,
        224,
        ...
        },
        {
          ...
          "pda": {
            "seeds": [
              ...
              {
                "kind": "account",
                "path": "user_account.total_positions",
                "account": "userAccount"
              }
            ]
          }
